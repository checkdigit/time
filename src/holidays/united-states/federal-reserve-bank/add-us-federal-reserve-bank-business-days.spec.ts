...
describe('add-federal-reserve-bank-business-days', () => {
  ...
  it('works for 1 business day with Christmas Day and New Years observed on a Monday', () => {
    ...
    assert.deepEqual(
      addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 1 }, 1),
      {
        year: 2023,
        month: 0,
        date: 3,
    ...
    assert.deepEqual(
      addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 2 }, 1),
      {
        year: 2023,
        month: 0,
        date: 3,
    ...
    assert.deepEqual(
      addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 3 }, 1),
      {
        year: 2023,
        month: 0,
        date: 4,
  ...
  it('works for 2 business days when the daylight savings time begins in 2023', () => {
    assert.deepEqual(
      addUSFederalReserveBankBusinessDays({ year: 2023, month: 2, date: 8 }, 2),
      {
        year: 2023,
        month: 2,
        date: 10,
    ...
    assert.deepEqual(
      addUSFederalReserveBankBusinessDays({ year: 2023, month: 2, date: 9 }, 2),
      {
        year: 2023,
        month: 2,
        date: 13,
  ...
  it('works for 3 business days in a leap year when February 29th is a Sunday', () => {
    ...
    assert.deepEqual(
      addUSFederalReserveBankBusinessDays({ year: 2032, month: 2, date: 1 }, 3),
      {
        year: 2032,
        month: 2,
        date: 4,
