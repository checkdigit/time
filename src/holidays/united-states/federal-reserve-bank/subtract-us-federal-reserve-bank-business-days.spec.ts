// holidays/united-states/federal-reserve-bank/subtract-us-federal-reserve-bank-business-days.spec.ts
...
describe('subtract-federal-reserve-bank-business-days', () => {
  ...
  it('works for 1 business day with Christmas Day and New Years observed on a Monday', () => {
    ...
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 4 }, -1), {
      year: 2023,
      month: 0,
      date: 3,
    });
  ...
  it('works for 2 business days for the whole week with no federal holidays in between', () => {
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2022, month: 11, date: 11 }, -2), {
      year: 2022,
      month: 11,
      date: 8,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2022, month: 11, date: 12 }, -2), {
      year: 2022,
      month: 11,
      date: 8,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2022, month: 11, date: 13 }, -2), {
      year: 2022,
      month: 11,
      date: 9,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2022, month: 11, date: 14 }, -2), {
      year: 2022,
      month: 11,
      date: 12,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2022, month: 11, date: 15 }, -2), {
      year: 2022,
      month: 11,
      date: 13,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2022, month: 11, date: 16 }, -2), {
      year: 2022,
      month: 11,
      date: 14,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2022, month: 11, date: 17 }, -2), {
      year: 2022,
      month: 11,
      date: 15,
    });
  ...
  it('works for 2 business days for the whole week with a federal holiday(Thanksgiving Day) in between', () => {
    ...
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2022, month: 10, date: 27 }, -2), {
      year: 2022,
      month: 10,
      date: 23,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2022, month: 10, date: 28 }, -2), {
      year: 2022,
      month: 10,
      date: 23,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2022, month: 10, date: 29 }, -2), {
      year: 2022,
      month: 10,
      date: 25,
    });
  ...
  it('works for 2 business days when the daylight savings time begins in 2023', () => {
    ...
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 2, date: 15 }, -2), {
      year: 2023,
      month: 2,
      date: 13,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 2, date: 16 }, -2), {
      year: 2023,
      month: 2,
      date: 14,
    });
  ...
  it('works for 3 business days when the daylight savings time ends in 2023', () => {
    ...
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 10, date: 9 }, -3), {
      year: 2023,
      month: 10,
      date: 6,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 10, date: 10 }, -3), {
      year: 2023,
      month: 10,
      date: 7,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 10, date: 11 }, -3), {
      year: 2023,
      month: 10,
      date: 8,
    });
  ...
  it('works for 3 business days with Christmas Day and New Years observed on a Monday', () => {
    ...
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 1 }, -3), {
      year: 2022,
      month: 11,
      date: 28,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 2 }, -3), {
      year: 2022,
      month: 11,
      date: 28,
    });
    // Since 2023-01-02 is a Federal Reserve Holiday (observed) celebrating New Year's Day
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 3 }, -3), {
      year: 2022,
      month: 11,
      date: 28,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 4 }, -3), {
      year: 2022,
      month: 11,
      date: 29,
    });
  ...
  it('works for 3 business days in a leap year', () => {
    ...
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2024, month: 2, date: 1 }, -3), {
      year: 2024,
      month: 1,
      date: 27,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2024, month: 2, date: 2 }, -3), {
      year: 2024,
      month: 1,
      date: 28,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2024, month: 2, date: 3 }, -3), {
      year: 2024,
      month: 1,
      date: 28,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2024, month: 2, date: 4 }, -3), {
      year: 2024,
      month: 1,
      date: 28,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2024, month: 2, date: 5 }, -3), {
      year: 2024,
      month: 1,
      date: 29,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2024, month: 2, date: 6 }, -3), {
      year: 2024,
      month: 2,
      date: 1,
    });
  ...
  it('works for 3 business days in a leap year when February 29th is a Sunday', () => {
    ...
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2032, month: 2, date: 2 }, -3), {
      year: 2032,
      month: 1,
      date: 26,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2032, month: 2, date: 3 }, -3), {
      year: 2032,
      month: 1,
      date: 27,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2032, month: 2, date: 4 }, -3), {
      year: 2032,
      month: 2,
      date: 1,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2032, month: 2, date: 5 }, -3), {
      year: 2032,
      month: 2,
      date: 2,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2032, month: 2, date: 6 }, -3), {
      year: 2032,
      month: 2,
      date: 3,
    });
  ...
  it('works for 20 business days every hour with three federal holidays in between', () => {
    ...
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 23 }, -20), {
      year: 2022,
      month: 11,
      date: 21,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 24 }, -20), {
      year: 2022,
      month: 11,
      date: 22,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 25 }, -20), {
      year: 2022,
      month: 11,
      date: 23,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 26 }, -20), {
      year: 2022,
      month: 11,
      date: 27,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 27 }, -20), {
      year: 2022,
      month: 11,
      date: 28,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 28 }, -20), {
      year: 2022,
      month: 11,
      date: 29,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 29 }, -20), {
      year: 2022,
      month: 11,
      date: 29,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 30 }, -20), {
      year: 2022,
      month: 11,
      date: 29,
    });
    assert.deepEqual(addUSFederalReserveBankBusinessDays({ year: 2023, month: 0, date: 31 }, -20), {
      year: 2022,
      month: 11,
      date: 30,
    });
