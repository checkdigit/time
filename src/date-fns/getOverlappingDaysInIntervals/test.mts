...
describe('getOverlappingDaysInIntervals', () => {
  ...
  describe('when the time intervals overlap', () => {
    ...
    it('considers equal 0-lenght intervals not overlapping', () => {
      ...
      const numOverlappingDays = getOverlappingDaysInIntervals({ start: date, end: date }, { start: date, end: date });
      expect(numOverlappingDays).toBe(0);
    });
    ...
    it('considers equal 1ms-length intervals overlapping', () => {
      ...
      const numOverlappingDays = getOverlappingDaysInIntervals({ start, end }, { start, end });
      expect(numOverlappingDays).toBe(1);
    });
  });
