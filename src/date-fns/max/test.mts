...
describe('max', () => {
  it('returns the latest date', () => {
    const result = max([new Date(1989, 6 /* Jul */, 10), new Date(1987, 1 /* Feb */, 11)]);
  ...
  it('accepts timestamps', () => {
    const result = max([new Date(1989, 6 /* Jul */, 10).getTime(), new Date(1987, 1 /* Feb */, 11).getTime()]);
    expect(result).toEqual(new Date(1989, 6 /* Jul */, 10));
  });

  it('returns `Invalid Date` if any given date is invalid', () => {
    const result = max([new Date(1989, 6 /* Jul */, 10), new Date(NaN), new Date(1987, 1 /* Feb */, 11)]);
