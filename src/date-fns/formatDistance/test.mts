...
describe('formatDistance', () => {
  describe('seconds', () => {
    describe('when the includeSeconds option is true', () => {
      it('less than 5 seconds', () => {
        const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1986, 3, 4, 10, 32, 3), {
          includeSeconds: true,
        });
      ...
      it('less than 10 seconds', () => {
        const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1986, 3, 4, 10, 32, 7), {
          includeSeconds: true,
        });
      ...
      it('less than 20 seconds', () => {
        const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1986, 3, 4, 10, 32, 15), {
          includeSeconds: true,
        });
      ...
      it('half a minute', () => {
        const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1986, 3, 4, 10, 32, 25), {
          includeSeconds: true,
        });
      ...
      it('less than a minute', () => {
        const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1986, 3, 4, 10, 32, 45), {
          includeSeconds: true,
        });
      ...
      it('1 minute', () => {
        const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1986, 3, 4, 10, 33, 0), {
          includeSeconds: true,
        });
  ...
  describe('minutes', () => {
    it('less than a minute', () => {
      const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1986, 3, 4, 10, 32, 20));
      expect(result).toBe('less than a minute');
    });

    it('1 minute', () => {
      const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1986, 3, 4, 10, 32, 50));
      expect(result).toBe('1 minute');
    });

    it('n minutes', () => {
      const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1986, 3, 4, 10, 34, 50));
  ...
  describe('years', () => {
    ...
    it('almost n years', () => {
      const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1989, 2, 4, 10, 32, 0));
      expect(result).toBe('almost 3 years');
    });

    it('about n years', () => {
      const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1989, 3, 4, 10, 32, 0));
      expect(result).toBe('about 3 years');
    });

    it('over n years', () => {
      const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0), new Date(1989, 9, 4, 10, 32, 0));
      expect(result).toBe('over 3 years');
    });
  });

  it('accepts timestamps', () => {
    const result = formatDistance(new Date(1986, 3, 4, 10, 32, 0).getTime(), new Date(1986, 3, 4, 11, 32, 0).getTime());
    expect(result).toBe('about 1 hour');
  });
  ...
  describe('when the addSuffix option is true', () => {
    ...
    it('adds a future suffix', () => {
      const result = formatDistance(new Date(1986, 3, 4, 11, 32, 0), new Date(1986, 3, 4, 10, 32, 0), {
        addSuffix: true,
      });
  ...
  describe('custom locale', () => {
    it('can be passed to the function', () => {
      ...
      const result = formatDistance(new Date(1986, 3, 4, 10, 32, 3), new Date(1986, 3, 4, 10, 32, 0), {
        includeSeconds: true,
        addSuffix: true,
        locale: customLocale,
      });
