...
import { lastDayOfDecade } from './index';
...
describe('lastDayOfDecade', () => {
  ...
  it('properly works with negative numbers', () => {
    expect(lastDayOfDecade(new Date(2001, 0, 1))).toEqual(new Date(2009, 11, 31));
    expect(lastDayOfDecade(new Date(-2009, 0, 1))).toEqual(new Date(-2001, 11, 31));
  });
});
