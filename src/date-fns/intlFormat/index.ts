...
export default function intlFormat<DateType extends Date>(date: DateType, localeOptions: LocaleOptions): string;

export default function intlFormat<DateType extends Date>(date: DateType, formatOptions: FormatOptions): string;
...
function isFormatOptions(opts: LocaleOptions | FormatOptions | undefined): opts is FormatOptions {
