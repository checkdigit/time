...
describe('lightFormat', () => {
  ...
  describe('hour', () => {
    it('hour [1-12]', () => {
      const result = lightFormat(new Date(2018, 0 /* Jan */, 1, 0, 0, 0, 0), 'h hh');
    ...
    describe('AM, PM', () => {
      it('works as expected', () => {
        const result = lightFormat(new Date(2018, 0 /* Jan */, 1, 0, 0, 0, 0), 'a aa aaa aaaa aaaaa');
        expect(result).toBe('AM AM am a.m. a');

        const pmResult = lightFormat(new Date(2018, 0 /* Jan */, 1, 13, 0, 0, 0), 'a aa aaa aaaa aaaaa');
