...
import { differenceInMinutes } from './index';

describe('differenceInMinutes', () => {
  it('returns the number of minutes between the given dates', () => {
    const result = differenceInMinutes(new Date(2014, 6 /* Jul */, 2, 12, 20), new Date(2014, 6 /* Jul */, 2, 12, 6));
  ...
  it('returns a negative number if the time value of the first date is smaller', () => {
    const result = differenceInMinutes(new Date(2014, 6 /* Jul */, 2, 12, 6), new Date(2014, 6 /* Jul */, 2, 12, 20));
    expect(result).toBe(-14);
  });
  ...
  describe('edge cases', () => {
    ...
    it('the given dates are the same', () => {
      const result = differenceInMinutes(new Date(2014, 8 /* Sep */, 5, 0, 0), new Date(2014, 8 /* Sep */, 5, 0, 0));
      expect(result).toBe(0);
    });
  ...
  it('returns NaN if the first date is `Invalid Date`', () => {
    const result = differenceInMinutes(new Date(NaN), new Date(2017, 0 /* Jan */, 1));
    expect(isNaN(result)).toBe(true);
  });

  it('returns NaN if the second date is `Invalid Date`', () => {
    const result = differenceInMinutes(new Date(2017, 0 /* Jan */, 1), new Date(NaN));
    expect(isNaN(result)).toBe(true);
  });
