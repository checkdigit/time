...
describe('isSameMinute', () => {
  it('returns true if the given dates have the same minute', () => {
    const result = isSameMinute(new Date(2014, 8 /* Sep */, 4, 6, 30), new Date(2014, 8 /* Sep */, 4, 6, 30, 15));
    expect(result).toBe(true);
  });

  it('returns false if the given dates have different minutes', () => {
    const result = isSameMinute(new Date(2014, 8 /* Sep */, 4, 6, 30, 59), new Date(2014, 8 /* Sep */, 4, 6, 31));
