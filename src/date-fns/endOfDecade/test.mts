...
describe('endOfDecade', () => {
  ...
  it('properly works with negative numbers', () => {
    expect(endOfDecade(new Date(2001, 0, 1))).toEqual(new Date(2009, 11, 31, 23, 59, 59, 999));
    expect(endOfDecade(new Date(-2009, 0, 1))).toEqual(new Date(-2001, 11, 31, 23, 59, 59, 999));
  });
});
